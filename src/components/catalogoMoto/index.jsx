    ...
    <div className="container mt-4">
      ...
      <div className="text-end container mb-3">
        ...
        <button
          ...
          style={{ backgroundColor: '#df040b', padding: '15px', borderRadius: '15px' }}
      ...
      {productosParaMostrar.length > 0 && productosParaMostrar.length < productosFiltrados.length && (
        <div className="text-center mt-4">
          <button className="btn btn-outline-primary btn__mostrarMas" style={{ backgroundColor: '#df040b' }} onClick={cargarMas}>
              ...
              >
                ...
                <div className="modal-footer" style={{ borderTop: '1px solid #dee2e6' }}>
                  <button
                    ...
                    style={{ background: '#f23801', color: 'white', border: 'none' }}
                  >
                    Cerrar
                  </button>
                </div>
